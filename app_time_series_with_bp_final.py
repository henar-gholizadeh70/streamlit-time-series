...
if uploaded_file is not None:
    try:
        ...
        ax.plot(participant_data.index, participant_data['blood_pressure_systolic'], label='Systolic', color='royalblue', linewidth=2)
        ax.plot(participant_data.index, participant_data['blood_pressure_diastolic'], label='Diastolic', color='orangered', linewidth=2)

        ax.set_title(f'Blood Pressure Over Time (Participant {selected_pid})', fontsize=14)
